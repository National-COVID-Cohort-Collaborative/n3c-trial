...
<script>
$.getJSON("feeds/trials_by_condition_mesh.jsp?mode=${param.mode}", function(data){
	...
	table.id="condition_mesh_detail_table2";
	...
	var divContainer = document.getElementById("condition_mesh_detail_table");
	divContainer.innerHTML = "";
	divContainer.appendChild(table);

	var data = json['rows'];

	$('#condition_mesh_detail_table2').DataTable( {
    	data: data,
       	paging: true,
    	pageLength: 10,
